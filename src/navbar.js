...
<div class="nav-wrapper md:container md:mx-auto" style="background-color: transparent;">
  <nav class="navbar container-padding">
    <img v-if="showMenu" @click="navigateHome()" src="/assets/logo-black.png" alt="Company Logo" style="cursor: pointer; z-index: 100;">
    <img v-else @click="navigateHome()" src="/assets/logo-white.png" alt="Company Logo" style="cursor: pointer; z-index: 100;">
